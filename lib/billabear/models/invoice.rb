...
module Billabear
  class Invoice
    ...
    attr_accessor :biller_address

    attr_accessor :payeeaddress
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'pay_link')
        self.pay_link = attributes[:'pay_link']
      end
      ...
      if attributes.key?(:'biller_address')
        self.biller_address = attributes[:'biller_address']
      end

      if attributes.key?(:'payeeaddress')
        self.payeeaddress = attributes[:'payeeaddress']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          paid_at == o.paid_at &&
          due_date == o.due_date &&
          biller_address == o.biller_address &&
          payeeaddress == o.payeeaddress &&
          lines == o.lines
    end
    ...
    def hash
      [id, number, currency, customer, tax_total, sub_total, amount_due, paid, pay_link, created_at, paid_at, due_date, biller_address, payeeaddress, lines].hash
    end
