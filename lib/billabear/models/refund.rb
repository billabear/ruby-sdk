...
module Billabear
  class Refund
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'billing_admin')
        self.billing_admin = attributes[:'billing_admin']
      end
    end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('Object', ['started', 'rejected', 'authorised', 'issued'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Object', ['started', 'rejected', 'authorised', 'issued'])
    ...
    def hash
      [id, amount, currency, external_reference, comment, status, created_at, payment, customer, billing_admin].hash
    end
