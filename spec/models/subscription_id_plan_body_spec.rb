...
# Unit tests for SwaggerClient::SubscriptionIdPlanBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionIdPlanBody' do
  before do
    # run before each test
    @instance = SwaggerClient::SubscriptionIdPlanBody.new
  end
  ...
  describe 'test an instance of SubscriptionIdPlanBody' do
    it 'should create an instance of SubscriptionIdPlanBody' do
      expect(@instance).to be_instance_of(SwaggerClient::SubscriptionIdPlanBody)
    end
  end
