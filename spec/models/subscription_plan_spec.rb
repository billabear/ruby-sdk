...
# Unit tests for SwaggerClient::SubscriptionPlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionPlan' do
  before do
    # run before each test
    @instance = SwaggerClient::SubscriptionPlan.new
  end
  ...
  describe 'test an instance of SubscriptionPlan' do
    it 'should create an instance of SubscriptionPlan' do
      expect(@instance).to be_instance_of(SwaggerClient::SubscriptionPlan)
    end
  end
